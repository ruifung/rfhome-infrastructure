...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("forgejo");
			params.setVersion("0.5.4");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3N2YWxhYnMvZm9yZ2VqbyIsInZlcnNpb24iOiIwLjUuNCJ9fQ=="), c => c.charCodeAt(0)));
