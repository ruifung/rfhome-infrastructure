...
export class PropertyMappingRadius extends pulumi.CustomResource {
    ...
    declare public readonly propertyMappingRadiusId: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: PropertyMappingRadiusArgs | PropertyMappingRadiusState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["propertyMappingRadiusId"] = state?.propertyMappingRadiusId;
        } else {
            ...
            resourceInputs["propertyMappingRadiusId"] = args?.propertyMappingRadiusId;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(PropertyMappingRadius.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
