...
export class PropertyMappingSourceScim extends pulumi.CustomResource {
    ...
    declare public readonly propertyMappingSourceScimId: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: PropertyMappingSourceScimArgs | PropertyMappingSourceScimState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["propertyMappingSourceScimId"] = state?.propertyMappingSourceScimId;
        } else {
            ...
            resourceInputs["propertyMappingSourceScimId"] = args?.propertyMappingSourceScimId;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(PropertyMappingSourceScim.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
