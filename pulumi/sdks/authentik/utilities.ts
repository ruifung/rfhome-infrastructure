...
export async function getPackage(): Promise<string | undefined> {
	return runtime.registerPackage({
		...
		baseProviderVersion: "1.0.1",
		baseProviderDownloadUrl: "",
		packageName: "authentik",
		packageVersion: "2025.10.0",
		base64Parameter: "eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2dvYXV0aGVudGlrL2F1dGhlbnRpayIsInZlcnNpb24iOiIyMDI1LjEwLjAifX0=",
	});
}
