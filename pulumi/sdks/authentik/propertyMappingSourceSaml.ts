...
export class PropertyMappingSourceSaml extends pulumi.CustomResource {
    ...
    declare public readonly propertyMappingSourceSamlId: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: PropertyMappingSourceSamlArgs | PropertyMappingSourceSamlState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["propertyMappingSourceSamlId"] = state?.propertyMappingSourceSamlId;
        } else {
            ...
            resourceInputs["propertyMappingSourceSamlId"] = args?.propertyMappingSourceSamlId;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(PropertyMappingSourceSaml.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface PropertyMappingSourceSamlState {
    ...
    propertyMappingSourceSamlId?: pulumi.Input<string | undefined>;
}
